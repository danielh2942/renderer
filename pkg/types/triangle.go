...
func MakeTriangle(p1, p2, p3 primitives.Vector2d) Triangle {
	return Triangle{
		Point1: p1,
		Point2: p2,
		Point3: p3,
		Centroid: primitives.Vector2d{
			X: (p1.X + p2.X + p3.X) / 3,
			Y: (p1.Y + p2.Y + p3.Y) / 3,
		},
	}
...
type Triangle struct {
	Point1   primitives.Vector2d `json:"Point1"`   // Point 1 of the Triangle
	Point2   primitives.Vector2d `json:"Point2"`   // Point 2 of the Triangle
	Point3   primitives.Vector2d `json:"Point3"`   // Point 3 of the Triangle
	Centroid primitives.Vector2d `json:"Centroid"` // The Centroid of the Triangle
}
...
func (t *Triangle) calculateCentroid() {
	t.Centroid = primitives.Vector2d{
...
func (t *Triangle) Translate(vec primitives.Vector2d) {
...
func (t *Triangle) RotateAbout(vec primitives.Vector2d, angleRads float64) {
...
func (t *Triangle) Render() ([]primitives.Vector2d, error) {
	// 1 -> 2
	// 2 -> 3
	// 1 -> 3
